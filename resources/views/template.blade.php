...
<head>
    ...
    <link href="{{ asset('compiled/css/all.css') }}" rel="stylesheet" type="text/css" />
        ...
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/history') }}"><i class="icon-pie-chart"></i> History</a>
                    </li>
                    <li class="nav-title">
                        Data Pendukung
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/kota') }}"><i class="icon-pie-chart"></i> Data Radius Kota</a>
                    </li>
                    <li class="divider"></li>
                </ul>
            </nav>
